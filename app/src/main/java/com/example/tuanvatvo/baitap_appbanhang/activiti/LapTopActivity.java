...
import com.example.tuanvatvo.baitap_appbanhang.adapter.LapTopAdapter;
...
public class LapTopActivity extends AppCompatActivity {
    ...
    int idLT = 0; // nhận về từ beenActivityMain gửi đến
    int page = 1;
    ...
    private void addControls() {
        ...
        adapterLaptop = new LapTopAdapter(LapTopActivity.this,R.layout.item_lap_top,arrlapTop);
    ...
    private void LoadmoreData() {
        ...
        lvlapTop.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("thongtinsanpham",arrlapTop.get(i)); // chuển  1 object
